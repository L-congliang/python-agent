...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_off | 100% | 100% (6/6) | 0% | 100% | 1.5 | 19.0s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| delayed_dual_constant_edit | edit_dependency | ✅ | 0 | 0 | 3 | 18.1s |  |
| conflict_secret_disambiguation_strict | noise | ✅ | 0 | 1 | 0 | 13.1s |  |
| cross_file_literal_bundle_no_reread | cross_file_dep | ✅ | 0 | 0 | 2 | 16.5s |  |
| resume_multi_edit_after_irrelevant_round | multi_round_edit | ✅ | 0 | 1 | 2 | 40.8s |  |
| constraint_then_edit_single_target | edit_dependency | ✅ | 0 | 0 | 2 | 17.8s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| forbidden_reread_multi_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 7.7s |  |
