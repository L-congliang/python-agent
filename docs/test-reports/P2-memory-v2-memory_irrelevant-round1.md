...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_irrelevant | 100% | 100% (10/10) | 6% | 100% | 2.0 | 12.3s | ✅ 正常 |
...
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 0 | 2 | 14.2s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 2 | 10.5s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 0 | 0 | 6 | 26.5s |  |
| edit_using_previous_fact_only | edit_dependency | ✅ | 0 | 0 | 3 | 10.8s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| recall_api_key | cross_round_recall | ✅ | 0 | 1 | 0 | 9.2s |  |
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 8.4s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 0 | 2 | 14.9s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 1 | 1 | 11.3s |  |
| forbidden_reread_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 5.9s |  |
...
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 18.7s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 5 | 13.7s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 6 | 23.5s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 1 | 2 | 12.1s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 2 | 10.7s |  |
| noise_cache_port | noise | ✅ | 0 | 0 | 2 | 9.3s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| edit_main_function | edit_dependency | ✅ | 0 | n/a | 3 | 7.5s |  |
