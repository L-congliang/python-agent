...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_off | 94% | 90% (9/10) | 6% | 100% | 1.9 | 13.1s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| disambiguate_db_vs_cache_secret | noise | ✅ | 0 | 1 | 0 | 9.3s |  |
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 0 | 2 | 12.6s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 2 | 10.3s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 0 | 1 | 5 | 17.8s |  |
| edit_using_previous_fact_only | edit_dependency | ✅ | 0 | 0 | 3 | 11.7s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| recall_api_key | cross_round_recall | ❌ | 0 | n/a | 0 | 17.9s | model_error |
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 8.9s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 0 | 2 | 14.2s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 1 | 1 | 13.6s |  |
| forbidden_reread_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 7.0s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| history_loop_config | history_reference | ✅ | 0 | 1 | 0 | 6.1s |  |
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 24.1s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 5 | 12.8s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 6 | 18.3s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 1 | 2 | 15.6s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 2 | 18.9s |  |
| noise_cache_port | noise | ✅ | 0 | 0 | 2 | 8.8s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| edit_main_function | edit_dependency | ✅ | 0 | n/a | 3 | 8.0s |  |
