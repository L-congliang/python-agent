...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_on | 100% | 100% (6/6) | 0% | 100% | 2.2 | 18.2s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| delayed_dual_constant_edit | edit_dependency | ✅ | 0 | 0 | 3 | 13.6s |  |
| conflict_secret_disambiguation_strict | noise | ✅ | 0 | 1 | 0 | 12.2s |  |
| cross_file_literal_bundle_no_reread | cross_file_dep | ✅ | 0 | 0 | 7 | 18.0s |  |
| resume_multi_edit_after_irrelevant_round | multi_round_edit | ✅ | 0 | 1 | 2 | 43.9s |  |
| constraint_then_edit_single_target | edit_dependency | ✅ | 0 | 1 | 1 | 12.6s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| forbidden_reread_multi_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 8.6s |  |
