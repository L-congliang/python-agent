...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_on | 100% | 100% (6/6) | 0% | 100% | 2.0 | 16.9s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| delayed_dual_constant_edit | edit_dependency | ✅ | 0 | 0 | 3 | 12.6s |  |
| conflict_secret_disambiguation_strict | noise | ✅ | 0 | 1 | 0 | 11.8s |  |
| cross_file_literal_bundle_no_reread | cross_file_dep | ✅ | 0 | 0 | 2 | 13.0s |  |
| resume_multi_edit_after_irrelevant_round | multi_round_edit | ✅ | 0 | 0 | 5 | 36.2s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| forbidden_reread_multi_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 8.5s |  |
