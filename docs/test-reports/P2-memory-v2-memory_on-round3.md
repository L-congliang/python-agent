...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_on | 100% | 100% (10/10) | 11% | 100% | 2.2 | 21.1s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| disambiguate_db_vs_cache_secret | noise | ✅ | 0 | 1 | 0 | 11.7s |  |
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 1 | 1 | 14.3s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 2 | 17.9s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 0 | 0 | 5 | 48.2s |  |
| edit_using_previous_fact_only | edit_dependency | ✅ | 0 | 0 | 3 | 22.4s |  |
...
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 14.1s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 0 | 3 | 27.1s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 0 | 2 | 24.8s |  |
| forbidden_reread_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 11.0s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| history_loop_config | history_reference | ✅ | 0 | 1 | 0 | 8.8s |  |
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 25.3s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 4 | 20.3s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 6 | 33.6s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 0 | 5 | 30.7s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 2 | 20.7s |  |
| noise_cache_port | noise | ✅ | 0 | 0 | 2 | 22.2s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| edit_main_function | edit_dependency | ✅ | 1 | n/a | 4 | 15.4s |  |
