...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_on | 94% | 90% (9/10) | 6% | 100% | 2.2 | 20.7s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| disambiguate_db_vs_cache_secret | noise | ✅ | 0 | 1 | 0 | 8.5s |  |
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 0 | 2 | 27.2s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 3 | 23.6s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 0 | 0 | 6 | 39.8s |  |
| edit_using_previous_fact_only | edit_dependency | ✅ | 0 | 0 | 3 | 17.1s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| recall_api_key | cross_round_recall | ❌ | 0 | n/a | 0 | 20.5s | model_error |
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 12.5s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 0 | 2 | 22.9s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 0 | 2 | 19.9s |  |
| forbidden_reread_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 7.4s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| history_loop_config | history_reference | ✅ | 0 | 1 | 0 | 16.4s |  |
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 22.7s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 4 | 14.7s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 6 | 34.9s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 0 | 5 | 33.6s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 2 | 25.7s |  |
| noise_cache_port | noise | ✅ | 0 | 0 | 2 | 14.8s |  |
