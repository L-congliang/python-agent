...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_irrelevant | 100% | 100% (10/10) | 6% | 100% | 2.1 | 13.3s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| disambiguate_db_vs_cache_secret | noise | ✅ | 0 | 1 | 0 | 5.8s |  |
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 0 | 2 | 13.2s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 3 | 15.2s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 0 | 0 | 6 | 26.2s |  |
| edit_using_previous_fact_only | edit_dependency | ✅ | 0 | 0 | 2 | 10.1s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| recall_api_key | cross_round_recall | ✅ | 0 | 1 | 0 | 9.1s |  |
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 8.3s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 0 | 3 | 18.6s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 0 | 2 | 15.6s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| history_loop_config | history_reference | ✅ | 0 | 1 | 0 | 5.4s |  |
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 22.3s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 4 | 10.2s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 6 | 22.1s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 0 | 4 | 20.7s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 1 | 11.5s |  |
| noise_cache_port | noise | ✅ | 0 | 0 | 2 | 11.0s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| edit_main_function | edit_dependency | ✅ | 0 | n/a | 3 | 7.4s |  |
