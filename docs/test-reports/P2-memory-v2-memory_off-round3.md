...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_off | 100% | 100% (10/10) | 6% | 100% | 1.9 | 12.5s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| disambiguate_db_vs_cache_secret | noise | ✅ | 0 | 1 | 0 | 7.1s |  |
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 1 | 1 | 9.1s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 2 | 18.7s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 0 | 0 | 7 | 21.1s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| recall_api_key | cross_round_recall | ✅ | 0 | 1 | 0 | 8.2s |  |
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 8.0s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 0 | 2 | 13.3s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 1 | 1 | 10.6s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| history_loop_config | history_reference | ✅ | 0 | 1 | 0 | 8.1s |  |
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 22.0s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 4 | 11.1s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 6 | 22.5s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 1 | 2 | 15.4s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 2 | 12.1s |  |
| noise_cache_port | noise | ✅ | 0 | 0 | 2 | 10.8s |  |
