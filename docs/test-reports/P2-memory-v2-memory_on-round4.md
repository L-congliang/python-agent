...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_on | 100% | 100% (10/10) | 6% | 100% | 1.9 | 17.9s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| disambiguate_db_vs_cache_secret | noise | ✅ | 0 | 1 | 0 | 12.0s |  |
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 0 | 2 | 17.7s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 2 | 16.7s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 0 | 0 | 6 | 41.7s |  |
| edit_using_previous_fact_only | edit_dependency | ✅ | 0 | 0 | 2 | 9.1s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| recall_api_key | cross_round_recall | ✅ | 0 | 1 | 0 | 17.3s |  |
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 10.6s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 1 | 1 | 15.1s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 0 | 2 | 17.6s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| history_loop_config | history_reference | ✅ | 0 | 1 | 0 | 9.7s |  |
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 30.5s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 4 | 14.8s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 5 | 23.1s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 0 | 4 | 30.6s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 2 | 20.3s |  |
| noise_cache_port | noise | ✅ | 0 | 0 | 2 | 14.3s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| edit_main_function | edit_dependency | ✅ | 0 | n/a | 3 | 13.0s |  |
