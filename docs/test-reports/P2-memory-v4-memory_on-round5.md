...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_on | 83% | 83% (5/6) | 0% | 100% | 2.0 | 21.0s | ✅ 正常 |
...
### memory_on
- correct_rate: 83%
- **memory_dependent_success_rate: 83%**（L3/L4 任务 5/6）
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| delayed_dual_constant_edit | edit_dependency | ✅ | 0 | 0 | 3 | 19.4s |  |
| conflict_secret_disambiguation_strict | noise | ❌ | 0 | n/a | 0 | 27.1s | model_error |
| cross_file_literal_bundle_no_reread | cross_file_dep | ✅ | 0 | 0 | 2 | 14.3s |  |
| resume_multi_edit_after_irrelevant_round | multi_round_edit | ✅ | 0 | 0 | 5 | 34.8s |  |
| constraint_then_edit_single_target | edit_dependency | ✅ | 0 | 0 | 2 | 19.5s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| forbidden_reread_multi_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 10.6s |  |
