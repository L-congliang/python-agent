...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_off | 94% | 90% (9/10) | 6% | 100% | 2.1 | 14.8s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| disambiguate_db_vs_cache_secret | noise | ✅ | 0 | 1 | 0 | 7.2s |  |
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 0 | 2 | 14.0s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 2 | 14.7s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 0 | 0 | 6 | 29.9s |  |
| edit_using_previous_fact_only | edit_dependency | ✅ | 0 | 0 | 3 | 14.9s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| recall_api_key | cross_round_recall | ❌ | 0 | n/a | 0 | 13.7s | model_error |
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 7.6s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 0 | 2 | 13.6s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 0 | 2 | 12.8s |  |
| forbidden_reread_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 10.6s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| history_loop_config | history_reference | ✅ | 0 | 1 | 0 | 12.5s |  |
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 24.2s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 4 | 11.5s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 7 | 25.3s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 1 | 2 | 21.8s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 2 | 10.3s |  |
| noise_cache_port | noise | ✅ | 0 | 0 | 2 | 10.4s |  |
