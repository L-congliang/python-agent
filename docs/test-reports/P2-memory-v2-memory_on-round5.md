...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_on | 100% | 100% (10/10) | 11% | 94% | 2.2 | 18.9s | ✅ 正常 |
...
- target_reread_rate: 11%
- answer_without_reread_rate: 94%
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| disambiguate_db_vs_cache_secret | noise | ✅ | 0 | 1 | 0 | 11.4s |  |
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 1 | 1 | 15.3s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 2 | 28.3s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 2 | 0 | 9 | 38.1s |  |
| edit_using_previous_fact_only | edit_dependency | ✅ | 0 | 0 | 3 | 17.0s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| recall_api_key | cross_round_recall | ✅ | 0 | 1 | 0 | 14.3s |  |
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 10.8s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 0 | 3 | 18.4s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 0 | 2 | 19.4s |  |
| forbidden_reread_fact_answer | cross_round_recall | ✅ | 0 | 1 | 0 | 9.6s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| history_loop_config | history_reference | ✅ | 0 | 1 | 0 | 10.4s |  |
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 24.9s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 4 | 16.5s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 6 | 28.0s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 1 | 2 | 26.0s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 2 | 23.1s |  |
| noise_cache_port | noise | ✅ | 0 | 0 | 2 | 16.5s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| edit_main_function | edit_dependency | ✅ | 0 | n/a | 3 | 11.8s |  |
