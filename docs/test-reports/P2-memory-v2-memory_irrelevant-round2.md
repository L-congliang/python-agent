...
|------|-------------|------------------------------|-------------------|---------------------------|---------------|-------------|----------|
| memory_irrelevant | 100% | 100% (10/10) | 6% | 100% | 1.9 | 14.5s | ✅ 正常 |
...
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| disambiguate_db_vs_cache_secret | noise | ✅ | 0 | 1 | 0 | 7.0s |  |
| delayed_constraint_single_file_edit | edit_dependency | ✅ | 0 | 0 | 2 | 14.4s |  |
| cross_file_literal_recall_no_import | cross_file_dep | ✅ | 0 | 0 | 2 | 13.1s |  |
| multi_round_edit_after_noise | multi_round_edit | ✅ | 0 | 0 | 4 | 24.1s |  |
| edit_using_previous_fact_only | edit_dependency | ✅ | 0 | 0 | 3 | 12.9s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| recall_api_key | cross_round_recall | ✅ | 0 | 1 | 0 | 11.3s |  |
| recall_rate_limit | cross_round_recall | ✅ | 0 | 1 | 0 | 8.1s |  |
| dep_use_api_key | cross_file_dep | ✅ | 0 | 1 | 2 | 10.9s |  |
| dep_update_header | cross_file_dep | ✅ | 0 | 0 | 2 | 13.7s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| history_loop_config | history_reference | ✅ | 0 | 1 | 0 | 5.8s |  |
| history_manager_class | history_reference | ✅ | 0 | 1 | 0 | 23.5s |  |
| edit_config_update | edit_dependency | ✅ | 1 | n/a | 4 | 12.0s |  |
| multi_add_timeout | multi_round_edit | ✅ | 0 | 0 | 7 | 38.4s |  |
| multi_add_validation | multi_round_edit | ✅ | 0 | 1 | 2 | 21.2s |  |
| noise_db_config | noise | ✅ | 0 | 0 | 2 | 16.1s |  |
...
| task_id | category | correct | repeated_reads | memory_hit | tool_calls | duration | failed_reason |
|---------|----------|---------|----------------|------------|------------|----------|---------------|
| edit_main_function | edit_dependency | ✅ | 0 | n/a | 3 | 9.7s |  |
